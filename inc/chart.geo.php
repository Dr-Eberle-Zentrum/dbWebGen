...
HELPTEXT;
			...
			<label class="control-label">Display Mode</label>
				<div class="radio"  style="margin-top:0">
					<label class="">{$this->page->render_radio('geo-mode', 'markers', true)}<i>Markers</i> &mdash; uses circles to designate regions that are scaled according to a specified value (<a target="_blank" href="https://developers.google.com/chart/interactive/docs/gallery/geochart#markers-mode-format">required columns</a>)</label>
				</div>
				<div class="radio">
					<label class="">{$this->page->render_radio('geo-mode', 'regions')}<i>Regions</i> &mdash; colors whole regions, such as countries, provinces, or states (<a target="_blank" href="https://developers.google.com/chart/interactive/docs/gallery/geochart#regions-mode-format">required columns</a>)</label>
				</div>			
				<div class="radio">
					<label class="">{$this->page->render_radio('geo-mode', 'text')}<i>Text</i> &mdash; labels the regions with identifiers (e.g., "Russia" or "Asia") (<a target="_blank" href="https://developers.google.com/chart/interactive/docs/gallery/geochart#text-mode-format">required columns</a>)</label>
				</div>
			</div>
...
HTML;
		...
		//--------------------------------------------------------------------------------------
			return parent::options() + array(		
				'region' => $this->page->get_post('geo-region'),
				'displayMode' => $this->page->get_post('geo-mode'),
